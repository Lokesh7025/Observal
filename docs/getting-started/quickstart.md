...
| `observal-telemetry`  | `localhost:8125`        | Telemetry store (DuckDB)       |
...
The API waits for Postgres, the telemetry store, and Redis to pass health checks before starting. Expect 15–30 seconds. Confirm it is up:
