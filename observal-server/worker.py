...
from jobs.maintenance import maintain_telemetry, purge_inbox_items, sync_component_sources
...
class WorkerSettings:
    ...
    cron_jobs = [
        ...
        cron(maintain_telemetry, hour={0, 4, 8, 12, 16, 20}, timeout=900),  # Every 4 hours
