...
from services.user_search import resolve_user_filter_values, telemetry_user_conditions
...
async def get_security_events(
    ...
    """Query the deployment security event log."""
    del current_user
    ...
    if actor_email:
        ...
        actor_conditions = telemetry_user_conditions(
            id_column="actor_id",
