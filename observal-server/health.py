...
async def readiness(db: AsyncSession = Depends(get_db)):
    """K8s readiness probe. Checks Postgres, the telemetry store, and Redis connectivity."""
    ...
    from services.telemetry import telemetry_health

    if not await telemetry_health():
        checks["telemetry"] = "unreachable"
