...
- [Databases](docs/self-hosting/databases.md): Postgres, the DuckDB telemetry store, migrations, retention
...
| Databases | PostgreSQL 16 (registry), DuckDB telemetry store (single-writer service) |
| Queue | Redis + arq |
