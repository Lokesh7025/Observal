...
All Observal components (API, web frontend, worker, PostgreSQL, Redis, the DuckDB telemetry store, Grafana, nginx) run as Docker containers on the single instance.
